...
definition pinned to `readndraft-imap-mcp@0.6.0`. It does not contain secrets,
...
```console
uvx readndraft-imap-mcp@0.6.0 migrate-plugin --client codex
uvx readndraft-imap-mcp@0.6.0 migrate-plugin --client claude-code
```
